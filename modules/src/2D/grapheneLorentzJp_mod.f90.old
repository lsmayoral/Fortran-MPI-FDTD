...
!**************************************************************
	integer :: npols=4
	real*8 :: epinf=1.070682d0
	real*8, dimension(4) :: xi1=(/-0.163673d0,0.843432d0,-0.170024d0,-0.121134d0/)
	real*8, dimension(4) :: w0l=(2.d0*pi*c0/micro)*(/1.642784d0,0.807691d0,0.934364d0,0.525964d0/)
	real*8, dimension(4) :: dnu0l=(2.d0*pi*c0/micro)*(/2.267351d0,1.018179d0,0.621508d0,0.033048d0/)
...
subroutine update_Exz_inGraphene(this,Ex_pointer,Ey_pointer,Ez_pointer,Hx_pointer,Hy_pointer,Hz_pointer)
	...
	curlhyx=Hy_pointer(i,j,k)-Hy_pointer(i-1,j,k)
	    ...
	    Ku*this%ga(i,j,k)*(curlhyx+curlhxy-this%ds*this%JpxT(i,j,k))
	...
	subroutine initialize_Graphene(this,rangex,rangey,rangez,range_localdim)
	    class(SLG_LJp),intent(inout) :: this
	...
	end module grapheneLorentzJp_mod
