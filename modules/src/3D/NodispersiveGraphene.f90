	module nondispersivegrapheneJp_mod
	use constants_mod
	use mydatatypes
	use material_mod
	implicit none
	...
	type, extends(material):: SLG_ndJp
!**************************************************************
!	Nonlinear variables
!**************************************************************
	real*8,public :: wNL
...
!	real*8, dimension(3) :: xi1=(/4.957366d0,4.455092d0,1.905429d0/)
	real*8, dimension(3) :: xi1=(/0.d0,0.d0,0.d0/)
...
subroutine update_Exz_inGraphene(this,Ex_pointer,Ey_pointer,Ez_pointer,Hx_pointer,Hy_pointer,Hz_pointer)
	...
	subroutine initialize_Graphene(this,rangex,rangey,rangez,range_localdim)
	    class(SLG_ndJp),intent(inout) :: this
	...
	end module nondispersivegrapheneJp_mod